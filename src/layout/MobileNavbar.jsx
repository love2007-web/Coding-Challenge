  ...
  return (
    <>
      <div
        ...
        className={`${
          visible ? "fixed inset-0 bg-[#00000066] z-[8888]" : "hidden"
        }`}
      ></div>
      <nav
        className={`${
          visible
            ? "w-full h-screen pl-[47px] pr-[51px] py-[47px] rounded-[8px] bg-[#150E28] fixed top-0 right-0 transition-all z-[9999]"
            : "w-0 h-0"
        }`}
      >
