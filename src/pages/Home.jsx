          ...
          <Container className="grid lg:grid-cols-2 pt-8 lg:pt-24 !px-0 lg:!pl-12">
            <header className="grid place-items-center lg:place-items-start px-[30px] lg:px-0 lg:flex flex-col gap-5 pb-8">
              ...
              <div className="pt-5 text-white flex gap-4 lg:gap-6 relative z-2">
                <div className="flex">
                  <h1 className="font-unicaone text-[48px] lg:text-[64px]">
                    00
                  </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-[48px] max-w-max mx-auto">
            <figure className="col-start-1 lg:col-start-2 relative">
              ...
              <img
                src="/images/purple-lens-flare-left.svg"
                alt="purple lens flare"
                className="w- animate-pulse absolute w-[1037px] h-[948px] pointer-events-none top-[20px] right-[-350px] mix-blend-hard-light hidden lg:block"
              />
            </figure>
              ...
              <div className="w-full max-w-[535px] mx-auto grid place-items-center lg:block text-center lg:text-left">
                <header className="text-white text-[32px] font-clashdisplay font-bold relative ">
                  <img
                    src="/images/purple-lens-flare-left.svg"
                    alt="purple lens flare"
                    className="w- animate-pulse absolute w-[1037px] h-[948px] pointer-events-none top-[-420px] left-[20px] mix-blend-hard-light hidden lg:block"
                  />
                ...
                <div className="pt-2 relative z-2">
                  <p className="text-white text-[14px] leading-[27px]">
                    ...
                    you&rsquo;re a coding genius, a design maverick, or a
                    concept wizard, you&rsquo;ll have the chance to transform
                    your ideas into reality. Solving real-world problems,
                    pushing the boundaries of technology, and creating solutions
                    that can change the world, that&rsquo;s what we&rsquo;re all
                    about!
                  </p>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-[53px] max-w-max mx-auto pt-[100px]">
            <figure className="relative flex items-center">
              ...
              <img
                src="/images/purple-lens-flare-left.svg"
                alt="purple lens flare"
                className="absolute animate-pulse w-[1037px] h-[948px] pointer-events-none top-[-150px] lg:top-[150px] left-[-100px] mix-blend-hard-light  lg:block"
              />
            </figure>
            <div className="flex items-center pb-[78px] relative">
              <img
                ...
                alt="purple lens flare"
                className="absolute animate-pulse w-[1037px] h-[948px] pointer-events-none top-[400px] right-[-200px] mix-blend-hard-light"
              />
