        ...
        <div className="grid lg:grid-cols-2 gap-[109px] max-w-max mx-auto">
          <figure className="relative">
            ...
            <img
              src="/icons/arrow.svg"
              alt="Arrow"
              className="absolute w-[19px] h-[22px] lg:w-[49px] lg:h-[57px] bottom-[-15px] translate-x-[-50%] right-[50%] lg:right-[0px] lg:bottom-[0px] pointer-events-none"
            />
            <img
    ...
    <div className="border-b-[1px] border-[#ffffff2e]">
      <Container className="relative">
        <img
          src="/images/purple-lens-flare-left.svg"
          alt="purple lens flare"
          className="absolute pointer-events-none mix-blend-hard-light left-[-100px] min-[525px]:left-[-150px] top-[-100px] min-[525px]:top-[-200px] lg:top-[-280px]"
        />
        <img
          src="/images/purple-lens-flare-left.svg"
          alt="purple lens flare"
          className="absolute pointer-events-none top-[250px] min-[600px]:top-[300px] lg:top-[20px] right-[-200px] min-[600px]:right-[-400px] lg:right-[-600px] mix-blend-hard-light"
        />
